//Sat Aug 23 2025 05:45:32 GMT+0000 (Coordinated Universal Time)
...
const default_UA = "Mozilla/5.0 (iPhone; CPU iPhone OS 18_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.62(0x18003e30) NetType/WIFI Language/zh_CN",
  Referer = "https://servicewechat.com/wx19c782057b961ed8/10/page-frame.html",
...
class BasicClass {
  ...
  log(_0x24beca, _0x562c5a = {}) {
    var _0x46c1ad = "",
      _0x51150f = $.userCount.toString().length;
    if (this.index) {
  ...
  async request(_0x2fd194) {
    const _0x2548a9 = ["ECONNRESET", "EADDRINUSE", "ENOTFOUND", "EAI_AGAIN"],
      _0x416829 = ["TimeoutError"],
      _0x597b2d = [];
    var _0x57e2a5 = null,
      _0x54d059 = 0,
      _0x471e24 = _0x2fd194.fn || _0x2fd194.url;
    ...
    while (_0x54d059 < DEFAULT_RETRY) {
      try {
        ...
        _0x577f8a = null;
        let _0x47416f = null,
          _0x401f00 = _0x2fd194?.["timeout"] || this.got?.["defaults"]?.["options"]?.["timeout"]?.["request"] || DEFAULT_TIMEOUT,
          _0x1a9a59 = false;
    ...
    try {
      ...
      };
      {
        let {
          ...
          _0x59692c = $.get(_0x4e8858, "code", _0x3b2336);
        if (_0x59692c == 0) {
          let {
            userName: _0x13c1b4,
            unionid: _0x5252e9,
      ...
      }
      {
        let {
          ...
          _0x25c239 = $.get(_0x3cc2c6, "code", _0x5e972d);
        if (_0x25c239 == 0) {
  ...
  async cash_info(_0x4a8088 = {}) {
    try {
      ...
      let _0x46805f = {
        ...
        _0x7952f6 = $.get(_0xa5f928, "code", _0x29f447);
      if (_0x7952f6 == 0) {
  ...
  async checkin(_0x5e5d79, _0x4c25a8 = {}) {
    try {
      let _0x212985 = {
        ...
        _0x1e6649 = $.get(_0x38411e, "code", _0x20a69e);
      if (_0x1e6649 == 0) {
        let {
  ...
  return new class {
    ...
    async exitNow() {
      ...
      let _0x455322 = Date.now(),
        _0x2e7166 = (_0x455322 - this.startTime) / 1000;
      this.log("");
      const _0x279f00 = {
        time: true
      };
    ...
    async wait_until(_0x142cb7, _0x33d4b5 = {}) {
      let _0x23b101 = _0x33d4b5.logger || this,
        _0x569f86 = _0x33d4b5.interval || this.default_wait_interval,
        _0x4eb137 = _0x33d4b5.limit || this.default_wait_limit,
        _0x3a5799 = _0x33d4b5.ahead || this.default_wait_ahead;
      ...
      let _0x504207 = this.normalize_time(_0x142cb7) - _0x3a5799,
        _0x5ae525 = this.time("hh:mm:ss.S", _0x504207),
        _0x4a2cb7 = Date.now();
